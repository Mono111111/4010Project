...
class AlgorithmComparison:
    ...
    def train_dqn(self):
        ...
        # Calculate epsilon decay steps to match other algorithms
        epsilon_decay_steps = int(self.episodes * self.max_steps * 0.5) 
        
        agent = DQN_Agent(
            env,
            gamma=self.gamma,
            lr=self.alpha,  # Use alpha as learning rate for fair comparison
            batch_size=128,
            buffer_size=100000,
        ...
        for ep in range(self.eval_episodes):
            ...
            while not (terminated or truncated):
                if agent_type == 'Q-Learning':
                    ...
                    action = agent._epsilon_greedy(obs, greedy=True)
    ...
    def print_detailed_comparison(self):
        ...
        print(f"\n{'Metric':<30} {'Q-Learning':<20} {'SARSA':<20} {'DQN':<20}")
        print("-"*90)
        
        metrics = [
            ('Training Time (s)', 'training_time', 'lower'),
            ('Model Size', 'model_size', 'lower'),
...
def main():
    ...
    print("Note: All algorithms used identical hyperparameters for fair comparison.")
    print("Q-Learning: Off-policy, tabular, max Q-value")
    print("SARSA: On-policy, tabular, actual action Q-value")
    print("DQN: Off-policy, neural network, experience replay")
